    ...
    <footer className="border-t border-white/40 dark:border-surface-800/60 bg-white/50 dark:bg-surface-900/70 backdrop-blur-xl py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-surface-500 dark:text-surface-400">
              <li><a href="mailto:support@mahaliwise.com" className="hover:text-surface-900 dark:hover:text-surface-100 transition-colors">support@mahaliwise.com</a></li>
              <li><a href="tel:+254722729607" className="hover:text-surface-900 dark:hover:text-surface-100 transition-colors">+254 722 729 607</a></li>
            </ul>
          </div>
        </div>
        <div className="mt-16 pt-8 border-t border-surface-200/80 dark:border-surface-800/80 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-surface-500 dark:text-surface-400">© {new Date().getFullYear()} Mahaliwise. All rights reserved.</p>
